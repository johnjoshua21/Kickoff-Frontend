// src/components/OwnerLayout.jsx
import React, { useState } from 'react';
import { Link, Outlet, useLocation, useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import { LayoutDashboard, Building2, Calendar, Ban, User, LogOut, Menu, X } from 'lucide-react';
...
const OwnerLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Block Slots', href: '/owner/block-slots', icon: Ban },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            <div>
              <h1 className="text-2xl font-bold text-blue-600">KickOff</h1>
